...
import com.capstone.warungpintar.data.remote.model.response.NotificationEntity
...
interface ApiNotificationService {
    ...
    suspend fun getListHistory(@Path("email") email: String): ResponseAPI<List<NotificationEntity>>
}